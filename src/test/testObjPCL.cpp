...
const std::string pcd_dir("/home/bobin/Documents/code/Libraries/pcl/test/");
using namespace dso;
...
int main(int argc, char const *argv[]) {
  ...
  std::string pcdfile = pcd_dir + "table_scene_mug_stereo_textured.pcd";

  reader.read(pcdfile.c_str(), *cloud);
  std::cerr << "PointCloud has: " << cloud->points.size() << " data points."
            << std::endl;
